...
const {postFiles,listAllFiles,downloadFile, deleteFile,listAllFilestoStaff} =require('../Controller/FilesController');
const app = express();
...
Router.get('/Class/:classroomId',authenticateToken,listAllFilestoStaff)
